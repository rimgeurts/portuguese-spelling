...
function KPI({title, value}) {
    return (
        <div
            className={
                "bg-blue-100  w-[100px] h-[100px] text-blue-700  rounded-full flex flex-col items-center justify-center"
            }
        >
                            ...
                            <Dialog.Panel
                                ...
                                <div>
                                    <div
                                        ...
                                        <CheckIcon
                                            className="h-6 w-6 text-green-600 stroke-[2px]"
                                            aria-hidden="true"
                                        />
                                    </div>
                                    <div className="mt-3 text-center sm:mt-5">
                                        ...
                                        <div className="mt-2">
                                            <p className="text-sm text-gray-500">Results Breakdown</p>
                                            <div
                                                className={
                                                    "text-sm text-gray-500 flex justify-center gap-4 my-10"
                                                }
                                            >
                                                <KPI
                                                    title="Score"
